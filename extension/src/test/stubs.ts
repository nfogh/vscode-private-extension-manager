...
export class CommonStubs implements vscode.Disposable {
     ...
     * `_privateExtensionMarketplace.remoteHelper.getExtension` command so it returns
    ...
    public stubLocalExtension(extensionId: string, mockData?: Partial<vscode.Extension<any>>): void {
        ...
        this.executeCommandStub
            .withArgs('_privateExtensionMarketplace.remoteHelper.getExtension', extensionId)
            .resolves(result);
    }
}
